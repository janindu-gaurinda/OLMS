        ...
        <div class="d-flex align-items-center ms-auto bg_color22">
            ...
            <div class="row">
                <div class="col-auto pt-1">
                    <h4 class="text_color text-uppercase"><?php echo date('Y:m:d'); ?></h4>
                    <h4 class="text_color text-uppercase" id="current-time"></h4>
                </div>
            </div>
            <div class="vl bg-light mx-4" style="width: 2px; height: 60px;"></div>
            <div class="row me-2">
                <div class="col-auto pt-1 text-center">
                    ...
                    <h5 class="text-white mx-2 text_size text-center text-capitalize"> <?php echo isset($_SESSION['DISPLAYNAME']) ? $_SESSION['DISPLAYNAME'] : ''; ?></h5>
                </div>
            </div>
        </div>
    </div>
